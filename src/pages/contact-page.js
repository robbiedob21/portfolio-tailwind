...
export default function ContactPage() {
	return (
		<main>
			<section className="px-4 grid sm:grid-cols-2">
					<div className="flex flex-col gap-2 my-8">
						...
						<div className="flex items-center gap-4">
							...
							<a href="tel:+64211011105">
								<span className="font-medium text-lg">021 101 1105</span>
							</a>
						</div>
						<div className="flex items-center gap-4">
							<div className="h-12 w-12">
							...
							<a href="mailto:robbiedob21@gmail.com">
								<span className="font-medium text-lg">robbiedob21@gmail.com</span>
							</a>
						</div>
					</div>
					<div className="my-8">
						<ContactForm title="Let's Discuss Your Needs"/>
					</div>
			</section>
		</main>
	);
